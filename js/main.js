...
var getRandomArrElements = function (arr) {
  var randomArrElements = [];
  var randomQuantityOfArrElements = getRandomInteger(0, arr.length);
  for (var i = 0; i < randomQuantityOfArrElements; i++) {
    randomArrElements[i] = arr[i];
  }
